...
class TaxExemptPropertyClassValue : public QDjangoModel, IValuation
{
    Q_OBJECT
...
public:
    explicit TaxExemptPropertyClassValue(QObject *parent = 0);
    ...
    static std::unique_ptr<TaxExemptPropertyClassValue> fromXml(dataadvice::TaxExemptPropertyClassValues &values);
signals:
