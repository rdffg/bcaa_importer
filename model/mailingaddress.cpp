...
QString MailingAddress::modeOfDeliveryValue() const
{
    return m_modeOfDeliveryValue;
}

void MailingAddress::setModeOfDeliveryValue(const QString &modeOfDeliveryValue)
{
