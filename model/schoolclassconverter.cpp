...
static std::set<QString> railwayCodes = std::set<QString> { "24", "25", "26"};
        ...
        PropertyClassValue &schoolValue)
{
    ...
    if (std::any_of(taxExemptValues.begin(), taxExemptValues.end(), [](const std::unique_ptr<model::ValuesByETC>& val){ return val->taxExemptCode() == "04"; }))
    {
