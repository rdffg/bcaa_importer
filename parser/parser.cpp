...
std::unique_ptr<dataadvice::DataAdviceImpl> Parser::registerParser(bool forSummary)
{

    // Instantiate individual parsers.
    //
    std::unique_ptr<::dataadvice::DataAdviceImpl> DataAdvice_p = std::make_unique<::dataadvice::DataAdviceImpl>();
    ...
    ::dataadvice::FolioRecordImpl FolioRecord_p;
